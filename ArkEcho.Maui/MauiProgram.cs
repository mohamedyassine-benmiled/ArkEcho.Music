...
public class MauiProgram
{
    ...
    {
        AppEnvironment environment = new AppEnvironment(Resources.ARKECHOMAUI, mauiHelper.GetStringFromSettings(Resources.SERVERADDRESSSETTING), Debugger.IsAttached, executingPlatform, true);
